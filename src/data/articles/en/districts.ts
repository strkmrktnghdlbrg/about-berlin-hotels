...
export const districtArticlesEn: Article[] = [
  // ───────────────────────── CHARLOTTENBURG ─────────────────────────
  {
    ...
    description:
      "Hotels in Charlottenburg: long-established 4- and 5-star properties on Kurfürstendamm, quiet boutique hotels around Savignyplatz and fair-value City West options.",
    ...
    intro: [
      ...
      "The hotel landscape runs from historic grand hotels through design properties in period buildings to fair three-star properties with a good breakfast. Here are the verified properties that convince us - and exactly where they sit.",
    ],
    takeaways: [
    ...
    bestFor: ["Discerning travelers", "Shopping & classical culture", "Business travelers", "First-time visitors (west)"],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "For classic grand-hotel style there is no way past the Hotel Bristol Berlin on the Ku'damm and the Waldorf Astoria in the 32-story glass tower by the Gedächtniskirche. For something more design-driven, stay at the Hotel Zoo (with its Grace rooftop bar) or the architecturally playful Hotel Q!.",
      ...
      },
      {
        ...
        body: [
          "Yes. Around Bahnhof Zoo, regional trains, the S-Bahn ring and several U-Bahn lines meet - from here you reach Mitte, Hauptbahnhof and BER airport without stressful changes. Most of the properties in this guide sit no more than a ten-minute walk from a station.",
        ],
      },
      {
    ...
    faq: [
      {
        ...
        a: "The focus is on long-established 4- and 5-star properties and design hotels, plus a few solid three-star properties for mid-range budgets. Pure hostels are rarer than in eastern Berlin.",
      },
      {
        q: "Is Charlottenburg suitable for families?",
        a: "Yes - the area is quiet and safe, with the Tiergarten, the zoo and Charlottenburg Palace within reach. Family rooms are mostly found in the larger properties; for a broader family selection, look at Pankow.",
      },
      {
        q: "How much does a hotel in Charlottenburg cost?",
        a: "Solid three-star properties start around €95 per night, upscale four-star hotels around €165, and the grand hotels on the Ku'damm from €240 upwards.",
      },
      {
        q: "Does Charlottenburg work for business trips?",
        a: "Very well. Proximity to the exhibition grounds, fast connections and plenty of business-capable properties (InterContinental, Waldorf Astoria, Hampton by Hilton) make City West the classic business address.",
      },
    ],
  ...
  // ───────────────────────── FRIEDRICHSHAIN ─────────────────────────
  {
    ...
    description:
      "Boutique and design hotels in Friedrichshain-Kreuzberg: individual properties by the East Side Gallery, the Spree and the RAW grounds - Berlin's most creative district to stay in.",
    kicker: "District guide · East Berlin",
    intro: [
      "Friedrichshain-Kreuzberg is Berlin's creative epicenter: the East Side Gallery, Mercedes-Benz Arena, the RAW grounds and Markthalle Neun define the neighborhood. Instead of hotel chains, individual boutique and design properties dominate.",
    ...
    bestFor: ["Boutique lovers", "Night owls", "Creatives", "Younger travelers"],
    ...
    sections: [
      {
        ...
        body: [
          "Because no other district stands so completely for young, creative Berlin. You stay between galleries, corner stores, clubs and the riverbank - and the U1/U3 and S-Bahn still put you in Mitte quickly.",
      ...
      },
      {
        ...
        body: [
          ...
          "For a step up in luxury, book the Orania.Berlin on Oranienplatz with its live concerts in the salon. Budget-conscious travelers stay at the Schulz Hotel directly on the East Side Gallery.",
        ],
      },
      {
        heading: "How loud is it at night - and who should avoid it?",
        body: [
          "Around Warschauer Straße and the RAW grounds there is a lot going on at night; that is part of the appeal but no good for light sleepers. If you want to be near the scene without lying in the noise, pick a hotel toward southern Kreuzberg (Bergmannkiez) or facing the Spree.",
        ],
      },
      {
        heading: "What should you see in the neighborhood?",
        body: [
    ...
    faq: [
      {
        ...
        a: "Design-led properties start around €145–155 per night, the upscale Orania around €280. Affordable three-star options such as the Schulz Hotel start at roughly €75.",
      },
      {
        q: "Is the district suitable for first-time visitors?",
        a: "For younger travelers and anyone looking for alternative Berlin: absolutely. Classic first-time sightseers focused on the Brandenburg Gate and Museum Island stay more centrally in Mitte.",
      },
      {
        q: "How do I get to the center from here?",
  ...
  // ───────────────────────── PANKOW ─────────────────────────
  {
    ...
    intro: [
      ...
      "Instead of hotel chains, the picture is shaped by charming boutique properties, aparthotels and family-run guest houses - many in restored period buildings with stucco and courtyards.",
    ],
    takeaways: [
      "Prenzlauer Berg (part of Pankow) is Berlin's most family-friendly inner-city neighborhood.",
      "Many properties offer family rooms, apartments with kitchens and quiet locations away from tourist flows.",
      "Mauerpark, Kollwitzplatz and the Kulturbrauerei are the green and cultural anchors.",
    ],
    bestFor: ["Families", "Longer stays", "Travelers who want quiet", "Berlin regulars"],
    districtSlug: "pankow",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "A genuine original is the Hotel Oderberger in the former public baths of 1902 - with the historic swimming pool preserved and family rooms, a few minutes from Mauerpark. Myer's Hotel near Kollwitzplatz and the Ackselhaus with its themed rooms stand for personal boutique charm.",
    ...
    faq: [
      {
        q: "Are Pankow hotels well connected to the center?",
        a: "Yes. From Prenzlauer Berg the streetcars (M1, M10) and the U2 put you at Alexanderplatz in around 15 minutes. Weißensee and the north are further out, but quieter and cheaper.",
      },
      {
        q: "What does a family hotel in Pankow cost?",
        a: "Boutique and family properties usually sit between €110 and €165 per night. Apartments with a kitchen pay off especially from three to four nights.",
      },
      {
      ...
      },
      {
        ...
        a: "Certainly. The area is popular with couples and Berlin regulars who value quiet, good cafés and short trips into the center.",
      },
    ],
  ...
  // ───────────────────────── MITTE ─────────────────────────
  {
    ...
    description:
      "Hotels in Berlin-Mitte: from luxury properties by the Brandenburg Gate and Gendarmenmarkt to affordable rooms at Alexanderplatz - you cannot stay more centrally in Berlin.",
    kicker: "District guide · City center",
    intro: [
      "Mitte is Berlin's historic and geographic heart: Brandenburg Gate, Museum Island, the Reichstag, Gendarmenmarkt and Unter den Linden all sit within a couple of square miles. For a first visit to Berlin this is the most sensible place to stay.",
      "The range runs from legendary grand hotels to functional three-star properties at Alexanderplatz - everything on foot or a short U-Bahn ride from the major sights.",
    ],
    takeaways: [
      "Mitte offers the shortest walks to Berlin's iconic sights.",
      "It holds most of the city's five-star properties - but also affordable options around Alexanderplatz.",
      "Best micro-locations: Pariser Platz, Gendarmenmarkt, Hackescher Markt and Alexanderplatz.",
    ],
    bestFor: ["First-time visitors", "Luxury travelers", "Culture fans", "Short city breaks"],
    districtSlug: "mitte",
    categorySlug: "luxushotels",
    hotels: [
    ...
    sections: [
      {
        ...
        body: [
          "Because you reach almost everything on foot: Brandenburg Gate, the Reichstag, Museum Island, Unter den Linden and Gendarmenmarkt. On a short break with a classic sightseeing program, the central location saves real time every day.",
      ...
      },
      {
        ...
        body: [
          ...
          "For design-led central stays there is the AMANO Grand Central by Hauptbahnhof; for budget-conscious travelers the H2 Hotel directly at Alexanderplatz.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Both work. Five-star properties start around €290–480 per night, but solid three-star properties at the Alex begin at roughly €65. If you want to stay central and save, book toward Alexanderplatz or a mid-range design hotel.",
        ],
      },
    ],
    faq: [
      ...
      },
      {
        ...
        a: "From around €65 for functional three-star properties at Alexanderplatz to €480 for the top suites at the Adlon. Most four-star properties sit at €130–200.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. Around Hackescher Markt and Gendarmenmarkt evenings are busy with restaurants and theaters. The area counts as safe; Alexanderplatz gets rowdier at night.",
      },
    ],
  ...
  // ───────────────────────── SPANDAU ─────────────────────────
  {
    ...
    description:
      "Cheap hotels in Spandau: affordable Berlin stays with a historic old town, citadel and Havel waterfront - well connected and ideal for budget and trade-show travelers.",
    kicker: "District guide · West Berlin",
    intro: [
      "Spandau feels almost like its own small town: a historic old quarter, the citadel, the Havel waterfront. If you want to stay cheaply and still reach the center quickly by S-Bahn and U-Bahn, this is your district.",
      "Old Spandau itself has few large hotels - but the area works perfectly as an affordable base, for instance for trade-show visitors or travelers with a car. We show what matters and name verified budget properties within easy reach.",
    ],
    takeaways: [
      ...
      "Ideal for budget travelers, trade-show visitors and weekend trips by car.",
    ],
    bestFor: ["Budget travelers", "Trade-fair visitors", "Families with a car", "Old-town fans"],
    ...
    sections: [
      {
        ...
        body: [
          "If your budget is limited or you are arriving by car: yes. Spandau is significantly cheaper than the inner city, has a pretty historic old town and sits on the water. For pure sightseeing in Mitte, plan on 30–40 minutes of travel.",
          "Because the hotel supply within old Spandau itself is limited, it is worth looking at affordable, well-connected properties in neighboring City West - from there Spandau is only minutes away.",
        ],
      },
      {
        heading: "When do you get the lowest prices?",
        body: [
          "In the off season (November to February, outside trade shows and holidays) and midweek. Note: during the big conventions at the Funkturm, prices across the whole west rise noticeably - book early then.",
        ],
        bullets: [
          "Use the off season: winter (except Christmas/New Year) is cheapest.",
          "Book midweek rather than on weekends.",
          "Avoid the big convention weeks (IFA and the like) or reserve far ahead.",
        ],
      },
      {
        heading: "What is there to do in Spandau?",
        body: [
          "The Spandau Citadel (one of Europe's best-preserved Renaissance fortresses), the old town with its half-timbered houses and the Kolk quarter, plus walks and ferries along the Havel. In the weeks before Christmas, the Spandau market is one of Berlin's largest.",
        ],
      },
    ],
    faq: [
      {
        q: "How far is Spandau from the center?",
        a: "About 7 miles west. The U7 or the S-Bahn reach City West in about 20 minutes and Mitte in 30 to 40 minutes.",
      },
      {
        q: "What does a hotel in Spandau cost?",
        a: "Affordable properties start at roughly €60–80 per night. In neighboring City West, solid three-star properties start at around €95.",
      },
      {
        q: "Is Spandau suitable for families?",
        a: "Yes - quiet, on the water, with the citadel and parks. For travelers with a car, parking is a clear plus over the inner city.",
      },
      {
        q: "Does Spandau work for trade-show visitors?",
        a: "Very much so - the connection to the exhibition grounds at the Funkturm is good, and prices sit below those of the properties right by the convention grounds.",
      },
    ],
  ...
  // ───────────────────────── STEGLITZ ─────────────────────────
  {
    ...
    kicker: "District guide · Southwest Berlin",
    intro: [
      ...
      "If you want rest, nature and upscale quiet - and are happy to skip inner-city bustle - the southwest delivers exactly that. Here are the verified properties and where they sit.",
    ],
    takeaways: [
      "Steglitz-Zehlendorf is the quietest, greenest place to stay in Berlin.",
      "Great for spa stays, nature lovers and longer, restful stays.",
      "The Grunewald, the Wannsee and the Botanical Garden are right outside.",
    ],
    bestFor: ["Travelers who want quiet", "Nature lovers", "Spa travelers", "Longer stays"],
    ...
    sections: [
      ...
      {
        heading: "Which hotels do we recommend in the green southwest?",
        body: [
          ...
          "A charming, quieter alternative is the Harnack-Haus in Dahlem, built in 1929 as a conference center and run today as the guest house of the Max Planck Society - open to regular travelers as well.",
        ],
      },
      {
        heading: "What is there to do in the area?",
        body: [
          "Walks and bike rides in the Grunewald, a day at the Wannsee public beach, art around the Dahlem museums, a detour to the Glienicke Bridge or into the Botanical Garden. In summer the southwest of Berlin is a recreation paradise.",
        ],
      },
    ],
    faq: [
      {
        q: "How well connected is Steglitz-Zehlendorf to the center?",
      ...
      },
      {
        ...
        a: "The Schlosshotel and comparable properties sit in the upscale bracket from around €290 per night; charming conference and guest houses start at about €135.",
      },
      {
        q: "Does the district suit families?",
        a: "Yes, especially in summer: the public beach at Wannsee, the forests and the lakes are ideal. The trips into the center are longer, though.",
      },
      {
        q: "Are there real wellness and spa hotels?",
        a: "The green south of Berlin is the classic spa area. You will find an overview of the best properties in our wellness guide.",
      },
    ],
  ...
  // ───────────────────────── TEMPELHOF ─────────────────────────
  {
    ...
    description:
      "Hotels in Tempelhof-Schöneberg: central city hotels, boutique properties and budget options around Winterfeldtplatz, Tempelhofer Feld and close to KaDeWe.",
    ...
    intro: [
      ...
      "The hotel landscape runs from design properties through charming guest houses to fair-value city hotels - well connected, with KaDeWe and the Ku'damm within reach.",
    ],
    takeaways: [
      "Tempelhof-Schöneberg is central, lively and usually cheaper than Mitte.",
      "Schöneberg has the weekly market, the café culture and the queer Regenbogenkiez.",
      "Tempelhofer Feld is Berlin's largest open space - perfect for cycling and kite flying.",
    ],
    bestFor: ["Mid-range travelers", "City explorers", "LGBTQ+ travelers", "Families"],
  ...
  // ───────────────────────── NEUKÖLLN ─────────────────────────
  {
    ...
    description:
      "Cheap hotels in Neukölln: budget-friendly and creative places to stay between Maybachufer, Tempelhofer Feld and Rixdorf - Berlin's most exciting district for young travelers.",
    kicker: "District guide · South Berlin",
    intro: [
      "Neukölln is perhaps the most exciting district in today's Berlin: a main street of Arabic bakeries and shops, hip galleries, the Maybachufer canal and creative cafés all meet here. Budget-friendly properties and design hostels dominate.",
    ...
    takeaways: [
      ...
      "Great for foodies, young travelers and Berlin insiders off the tourist trail.",
      "Tempelhofer Feld, the Klunkerkranich and the Maybachufer are the highlights.",
    ],
    bestFor: ["Budget travelers", "Foodies", "Young travelers", "Berlin insiders"],
    ...
    sections: [
      {
        ...
        body: [
          "For price-conscious, curious travelers: absolutely. You stay in a lively, multicultural quarter with galleries, bars, corner stores and one of Berlin's best street-food scenes - at prices below the tourist hotspots.",
          "If you want quiet elegance or classic sightseeing on your doorstep, you are better off elsewhere; Neukölln trades on atmosphere rather than polish.",
        ],
      },
      {
        heading: "Which places to stay stand out?",
        body: [
          "The Hüttenpalast is genuinely one of a kind: in a former factory hall you sleep in vintage travel trailers and hand-built cabins - plus conventional rooms and a café in the courtyard. The huge Estrel Berlin on Sonnenallee is Germany's largest convention hotel, with its own show stage and good value for money.",
        ],
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Budget properties and special concepts start at around €95; the Estrel sits at roughly €110 - with a very high room count for Berlin and good availability.",
      },
      {
  ...
  // ───────────────────────── TREPTOW ─────────────────────────
  {
    ...
    description:
      "Lakeside hotels in Treptow-Köpenick: stay by the Müggelsee and the Spree with a spa, a beach and open water - Berlin's water district in the southeast.",
    kicker: "District guide · Southeast Berlin",
    intro: [
      ...
      "If you want to combine rest by the water, water sports and nature with the charm of a historic town center (Köpenick), the southeast offers the most relaxed version of Berlin.",
    ],
    takeaways: [
      "Treptow-Köpenick is Berlin's water and woodland corner - ideal for recuperation.",
      "The Müggelsee is Berlin's largest lake, with a public beach and boat rentals.",
      "Perfect for wellness travelers, water sports fans and nature-loving families.",
    ],
    bestFor: ["Wellness travelers", "Water sports fans", "Families", "Travelers who want quiet"],
    districtSlug: "treptow-koepenick",
    categorySlug: "wellness-hotels",
    hotels: ["hotel-mueggelsee-berlin"],
    sections: [
      {
        heading: "Who is a lakeside hotel in the southeast right for?",
        body: [
          ...
          "For a classic inner-city program, factor in the travel time (around 40 minutes to Mitte) - in return you get quiet and nature no central district can offer.",
        ],
      },
      {
        heading: "Which hotel do we recommend by the water?",
        body: [
          "The Hotel Müggelsee Berlin sits with 174 rooms directly on the city's largest lake - with its own beach, a large spa area and a restaurant with lake views. A popular wellness and weekend spot with Berliners themselves.",
        ],
      },
      {
    ...
    faq: [
      {
        q: "How far is Treptow-Köpenick from the center?",
        a: "The Müggelsee lies in the far southeast, around 40 minutes from Mitte by S-Bahn (S3) plus streetcar or bus. Treptow itself (Treptower Park) is considerably closer to the center.",
      },
      {
      ...
      },
      {
        ...
        a: "Very - the beach, boat rentals, the forests and the shallow water at the Müggelsee make it an ideal family and summer destination.",
      },
      {
        q: "Can you do water sports here?",
  ...
  // ───────────────────────── MARZAHN ─────────────────────────
  {
    ...
    intro: [
      ...
      "For very budget-conscious travelers and families interested in the gardens, the district is an honest, cheap base. Here is what to expect.",
    ],
    takeaways: [
    ...
    bestFor: ["Very budget-conscious travelers", "Families interested in gardens", "Longer stays"],
    ...
    sections: [
      {
        ...
        body: [
          "If price is your main criterion: yes. You get clean, functional rooms at Berlin's lowest rates. For sightseeing in Mitte, plan on around 30–40 minutes by U-Bahn or S-Bahn.",
      ...
      },
      {
        ...
        body: [
          "The ibis budget Berlin Hellersdorf offers freshly renovated, functional rooms from around €49 per night - with free Wi-Fi and the U5 within walking distance. For price-conscious travelers who mainly want a clean bed and good connections, it is an honest choice.",
        ],
      },
      {
        heading: "What is there to do in the area?",
        body: [
          "Above all the Gardens of the World with their Chinese, Japanese, Balinese and Oriental gardens, the cable car and the Kienberg viewpoint. Plus Biesdorf Palace, the Wuhletal valley for walking and the Eastgate shopping center.",
        ],
      },
    ],
    faq: [
      {
        q: "How far is Marzahn-Hellersdorf from the center?",
        a: "About 7 to 9 miles east. The U5 subway or the S7 commuter line reach Alexanderplatz and Mitte in about 30 to 40 minutes.",
      },
      {
        q: "What does a hotel here cost?",
        a: "Budget properties start at around €49 per night - it barely gets cheaper in Berlin.",
      },
      {
        q: "Is the district worth it for families?",
        a: "Mainly because of the Gardens of the World and the generous green spaces. The journeys into the center are longer, though.",
      },
      {
  ...
  // ───────────────────────── LICHTENBERG ─────────────────────────
  {
    ...
    description:
      "Hotels in Lichtenberg: fair-value business and mid-range properties in eastern Berlin with good connections, the Tierpark and the Stasi Museum - strong value for money.",
    kicker: "District guide · East Berlin",
    intro: [
    ...
    takeaways: [
      ...
      "Strong for business travelers and price-conscious city breaks.",
      "Highlights: Tierpark Berlin, the Stasi Museum and the waterside Rummelsburger Bucht.",
    ],
    bestFor: ["Business travelers", "Price-conscious city breaks", "Families"],
    ...
    sections: [
      {
        ...
        body: [
          "Because of the combination of price and connections: Lichtenberg sits directly east of Friedrichshain, is superbly served by S-Bahn, streetcar and regional trains (Bahnhof Lichtenberg) and is significantly cheaper than the inner city.",
          "The district is down-to-earth and unpretentious - ideal for business travelers and anyone looking for a fair room with short journeys into the center. Since the selection within Lichtenberg itself is limited, it is worth looking at well-connected properties in the adjoining Mitte/Alexanderplatz area.",
        ],
      },
      {
        heading: "What is there to do in Lichtenberg?",
        body: [
          "Tierpark Berlin is, at roughly 395 acres, one of Europe's largest landscape zoos. Add the Stasi Museum in the former headquarters of the Stasi, East Germany's secret police, Friedrichsfelde Palace and the up-and-coming Rummelsburger Bucht on the water.",
        ],
      },
      {
        heading: "Who should give the district a miss?",
        body: [
          "If you expect classic sightseeing on your doorstep or are after upscale luxury, Mitte or Charlottenburg suit you better. Lichtenberg is everyday Berlin: practical, affordable, well connected - but not a tourist hotspot.",
        ],
      },
    ],
    faq: [
      {
        q: "How well connected is Lichtenberg to the center?",
        a: "Very well. The S-Bahn (S5, S7, S75) and streetcars put you at Alexanderplatz in around 15 minutes. Bahnhof Lichtenberg is also an important regional and long-distance stop.",
      },
      {
        q: "What does a hotel in Lichtenberg cost?",
        a: "Business and mid-range properties mostly sit at €80–130 per night - cheaper than comparable properties in Mitte.",
      },
      {
  ...
  // ───────────────────────── REINICKENDORF ─────────────────────────
  {
    ...
    description:
      "Hotels in Reinickendorf: quiet family and mid-range properties in the green north of Berlin by the Tegeler See - 20 minutes to Mitte on the U6.",
    kicker: "District guide · North Berlin",
    intro: [
      ...
      "Note: the former Tegel airport (TXL) has been closed since 2020 - Berlin's airport today is BER in the southeast. Reinickendorf offers nature, water and quiet residential streets instead.",
    ],
    takeaways: [
      "Reinickendorf is green, quiet and quickly connected to Mitte via the U6.",
      "Ideal for families, anyone who wants quiet and travelers with a rental car.",
      "Tegel airport has been closed since 2020 - today you fly from BER.",
    ],
    bestFor: ["Families", "Travelers who want quiet", "Travelers with a rental car", "Nature lovers"],
    ...
    sections: [
      {
        ...
        body: [
          "For families and travelers who need quiet, want to stay in the green but reach the center quickly. The U6 gets you to Mitte in around 20 minutes; all around, the Tegeler See and the Tegeler Forst await.",
          "The north is also relaxed for travelers with a car - parking is far easier to find here than in the inner city.",
        ],
      },
      {
    ...
    faq: [
      {
        ...
        a: "Tegel airport (TXL) has been closed since November 2020; the site is being redeveloped as the \"Urban Tech Republic\". If you want a hotel near the airport today, book toward BER in the southeast of Berlin.",
      },
      {
        q: "How do I get from Reinickendorf to the center?",
      ...
      },
      {
        ...
        a: "Family and mid-range properties mostly sit at around €95–130 per night - fair for a quiet room in the green.",
      },
      {
        q: "Does the district suit families?",
        a: "Yes - quiet, green, by the water and with family-friendly properties (pool, sauna). The good U-Bahn link makes trips into the center easy.",
      },
    ],
  ...
  // ───────────────────────── POTSDAM ─────────────────────────
  {
    ...
    description:
      "Potsdam with Sanssouci Palace as a day trip from Berlin: park, palaces and how to get there - plus quiet hotels in Berlin's green southwest as a base.",
    ...
    intro: [
      ...
      "If you want to experience Potsdam at leisure, stay in Berlin's green southwest (Steglitz-Zehlendorf) or in Potsdam itself. Here are the highlights and the best base for them.",
    ],
    takeaways: [
      ...
      "Berlin's quiet southwest (Wannsee, Grunewald, Dahlem) works well as a base.",
    ],
    bestFor: ["Culture fans", "Day trippers", "Travelers who want quiet", "Couples"],
    districtSlug: "steglitz-zehlendorf",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Most easily on the S-Bahn line S7 to Potsdam Hauptbahnhof (around 40 minutes from Mitte), then on by streetcar or bus to the park. Regional trains (RE1) are quick too. A Berlin ABC day pass covers the journey.",
        ],
      },
      {
        heading: "Where is the best place to stay for a Potsdam visit?",
        body: [
          "If you want to combine the palace visit with a quiet night, Berlin's green southwest is ideal - for instance the Patrick Hellmann Schlosshotel in the Grunewald or the charming Harnack-Haus in Dahlem. From there Potsdam is a short trip away, and in the evening you get the quiet of forest and lakes.",
        ],
      },
    ],
    faq: [
      ...
      },
      {
        ...
        a: "No. Potsdam is the capital of Brandenburg and borders Berlin directly to the southwest. By S-Bahn it is as well connected as an outer district, though.",
      },
      {
      ...
      },
      {
        ...
        a: "Spring to early fall, when the park is in full bloom. Early in the day is quieter; summer weekends get busy.",
      },
    ],
